 ...
 *@title ProductSerivceImpl
 *@description
 *@author 小沥青
 *@version 1.0
 *@create 2023/6/12 16:57
 */
 ...
 * <p>
 * @CreateTime : 2023-06-12  16:57
 */
@DS("slave_1") //指定所操作的数据源
@Service
public class ProductSerivceImpl extends ServiceImpl<ProductMapper, Product> implements IProductSerivce {
}
